...
<template>
    ...
    <div class="userManagement">
                        ...
                        <Form ref="searchForm" :model="searchForm"
                            ...
                            <Row>
                                <Form-item label="单位名称">
                                    <Input v-model="searchForm.MainName"></Input>
                                </Form-item>
                            </Row>
                        </Form>
                        <Row>
        ...
        <!--新增编辑-->
        <maintenanceForm :modalShow="formShow"
                   :modalFormTitle="formTitle"
                   :parentForm="parentForm"
                   @listenModalForm="hideModel"
                   @refreshTableList="getTableList"></maintenanceForm>
        <!--是否删除框-->
    ...
    export default {
        ...
        methods: {
            ...
            async getTableList() {
                ...
                const res = await getMaintenancePagedList(params);
            ...
            async comfirmDel() {
                ...
                try {
                    const res = await delMaintenance({Id: this.delId});
                    if (res.success) {
